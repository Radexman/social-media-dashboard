const Navbar = ({ handleThemeSwitch }) => {
  return (
    <nav className="dark:bg-neutral-darkTheme-veryDarkBlueBgTop bg-neutral-lightTheme-lightGrayishBlue flex h-52 items-start justify-center rounded-b-[2em] p-6 md:p-0 md:pt-10">
